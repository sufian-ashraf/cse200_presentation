        ...
        \begin{center}
            \begin{tikzpicture}[scale=0.6]
                ...
                \node[blacknode] at (-2.5, 0) {10}
                    child {node[blacknode] at (-3.5, -1) {5}}
                    child {node[blacknode] at (-1.5, -1) {15}};
                
                % After
                \node at (2.5, 1.5) {\textbf{After inserting 12:}};
                \node[blacknode] at (2.5, 0) {10}
                    child {node[blacknode] at (1.5, -1) {5}}
                    child {node[rednode] at (3.5, -1) {15}
                        child {node[rednode] at (2.5, -2) {12}}
                        child[missing] {}
                    };
            \end{tikzpicture}
        \end{center}
