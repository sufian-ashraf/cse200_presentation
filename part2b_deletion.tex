...
\begin{frame}{Deletion}
    ...
    \begin{columns}[T]
        ...
        \vspace{0.2cm}
        \begin{itemize}
            \item \large No problem!
            \item \large Just remove it
            \item \textcolor{goodgreen}{\large \textbf{Properties still hold}}
        \end{itemize}
        ...
        \vspace{0.2cm}
        \begin{itemize}
            \item \large Oh boy\ldots
            \item \large Black height changes!
            \item \textcolor{accent}{\large \textbf{Need ``double black'' fix}}
            \item \large Complex cases
        \end{itemize}
    \end{columns}
...
\begin{frame}{Case 2: After Deleting the BLACK Node}
    ...
    \begin{columns}[c]
        ...
        \begin{itemize}
            \item \large Left path is now \textbf{shorter}
            \item \large Black-height \textcolor{badred}{\textbf{violated!}}
            \item \large We call this a\\[0.2cm]
...
\begin{frame}{Case 2: The Fix-up}
    \begin{columns}[T]
        ...
        \begin{itemize}
            ...
            \item<1-> \large \enspace\textbf{Recolor:} Node 3 $\to$ Black
            \item<5-> \large \textcolor{highlight}{\enspace \textbf{Tree is balanced!}}
        \end{itemize}
...
\begin{frame}{Fix Case 1 of 4: Sibling is \textcolor{rbred}{RED}}
    ...
    \begin{itemize}
        ...
        \item<2-> \large\enspace\textbf{Recolor:} S $\to$ Black, P $\to$ Red
...
\begin{frame}{Fix Case 2 of 4: Sibling \& Children All BLACK}
    ...
    \begin{itemize}
        ...
        \item<2-> \large \enspace Push the Double-Black \textbf{up to P}
...
\begin{frame}{Fix Case 4 of 4: Sibling's \textcolor{rbred}{Right} Child is \textcolor{rbred}{RED}}
    ...
    \begin{itemize}
        ...
        \item<2-> \large \enspace\textbf{Recolor} R $\to$ Black
